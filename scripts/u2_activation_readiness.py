#!/usr/bin/env python3
"""Read-only readiness check for local U2 Maker and Reviewer activation."""
...
def assess(
    ...
    *,
    ...
    operational_roles = activation.get("enabled_roles") == [
        "repository_reviewer",
        "scoped_maker",
    ]
    ...
    return {
        "schema_version": 1,
        "status": "READY_FOR_U2_WORK" if not blockers else "PAUSED_NOT_READY",
...
def main() -> int:
    ...
    return 0 if result["status"] == "READY_FOR_U2_WORK" else DENY
